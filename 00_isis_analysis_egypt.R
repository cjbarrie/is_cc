...
load(file = "data/analysis/full_d_egypt.RData")
...
full_fit_egypt <- stan(
  model_code = model_code_egypt,
  data = full_d_egypt,
  iter = 10000,
  #10000 iters for actual analysis
  warmup = 9500,
  #9500 warmup for actual analysis
  thin = 4,
  pars = c(
    'beta',
    'phi',
...
save(full_fit_egypt, file = 'data/analysis/full_fit_egypt.RData', compress = TRUE)